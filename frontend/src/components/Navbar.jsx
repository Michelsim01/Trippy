                            ...
                            <div className="flex items-center gap-4">
                                {!isAuthenticated ? (
                                    ...
                                    <>
                                        ...
                                        {/* Shopping Cart */}
                                        <Link to="/cart" className="p-2 hover:bg-neutrals-7 rounded-lg transition-colors relative">
                                            <svg className="w-6 h-6 text-neutrals-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        >
                                            ...
                                            {/* Dropdown Menu */}
                                            <div className={`absolute right-0 top-12 w-48 bg-white rounded-lg shadow-lg border border-neutrals-6 transition-all duration-200 z-[100] ${isDropdownOpen ? 'opacity-100 visible pointer-events-auto' : 'opacity-0 invisible pointer-events-none'
                                                }`}>
