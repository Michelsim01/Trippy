      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="flex items-center gap-1">
            ...
            <span className="text-neutrals-2 font-medium text-sm">{displayData.averageRating}</span>
          </div>
          <span className="text-neutrals-4 text-sm">({displayData.totalReviews} reviews)</span>
        </div>
