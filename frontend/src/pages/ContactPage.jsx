                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid lg:grid-cols-2 gap-8">
                                ...
                                <div className="bg-white rounded-lg p-8 shadow-sm">
                                    <h2 className="text-2xl font-semibold text-neutrals-1 mb-6">Send us a message</h2>
                                    ...
                                    <form className="space-y-6">
                                        ...
                                        <div>
                                            ...
                                            <select className="w-full px-4 py-3 border border-neutrals-6 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-1">
                                        ...
                                        <button
                                            type="submit"
                                            className="w-full bg-primary-1 text-white px-6 py-3 rounded-lg font-medium hover:opacity-90 transition-colors"
                                        >
                                            Send Message
                                        </button>
                                    </form>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-primary-1 opacity-10 rounded-lg p-6">
                                        <h3 className="text-xl font-semibold text-neutrals-1 mb-2">Need quick answers?</h3>
                ...
                <main className="w-full p-4">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="bg-white rounded-lg p-6 shadow-sm mb-6">
                            <h2 className="text-xl font-semibold text-neutrals-1 mb-4">Send us a message</h2>
                            ...
                            <form className="space-y-4">
                                ...
                                <button
                                    type="submit"
                                    className="w-full bg-primary-1 text-white px-6 py-3 rounded-lg font-medium"
                                >
                                    Send Message
                                </button>
                            </form>
                        ...
                        <div className="bg-white rounded-lg p-6 shadow-sm">
                            <h3 className="text-lg font-semibold text-neutrals-1 mb-4">Get in touch</h3>
                            <div className="space-y-3 text-sm">
                                <p><span className="font-medium">Email:</span> hello@trippy.com</p>
