...
const SignInPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Clear field errors and suspension alert
        ...
        try {
            ...
            if (!result.success) {
                // Handle account suspension - show alert with link to support
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-3">
                                    ...
                                    <div className="mt-2 text-sm text-red-700">
                                        <p>
                                            Your account has been suspended. If you believe this is an error, you can 
                                            <button 
                                                onClick={() => navigate('/support')}
                                                className="ml-1 underline font-medium hover:text-red-900 transition-colors"
                                            >
                                                click here
                                            </button>
                                            {' '}to submit a ticket and appeal for an unban.
                                        </p>
                                    </div>
                                </div>
                            </div>
