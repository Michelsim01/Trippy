...
echo "   • 95 users (15 guides + 80 travelers) with 0 trip points"
echo "   • 1 admin user (admin@trippy.com) with password: Password123"
echo "   • 100 diverse experiences across all categories"
echo "   • 300-500 experience schedules (past and future)"
echo "   • Bookings for 80 active travelers"
echo "   • Reviews for ~70% of completed bookings"
echo "   • User surveys for all 95 users"
echo "   • Wishlist items for travelers"
echo "   • 102 FAQs for the platform"
echo ""
