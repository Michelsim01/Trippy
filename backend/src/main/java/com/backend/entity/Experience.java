...
public class Experience {
    ...
    public void setWhatIncluded(String whatIncluded) { this.whatIncluded = whatIncluded; }
    public String getImportantInfo() { return importantInfo; }
    public void setImportantInfo(String importantInfo) { this.importantInfo = importantInfo; }
    public BigDecimal getPrice() { return price; }
    public void setPrice(BigDecimal price) { this.price = price; }
    public Integer getParticipantsAllowed() { return participantsAllowed; }
    public void setParticipantsAllowed(Integer participantsAllowed) { this.participantsAllowed = participantsAllowed; }
    ...
    public List<ExperienceMedia> getMediaList() { return mediaList; }
    public void setMediaList(List<ExperienceMedia> mediaList) { this.mediaList = mediaList; }
    public List<ExperienceItinerary> getItineraries() { return itineraries; }
    public void setItineraries(List<ExperienceItinerary> itineraries) { this.itineraries = itineraries; }
    public List<ExperienceSchedule> getSchedules() { return schedules; }
    public void setSchedules(List<ExperienceSchedule> schedules) { this.schedules = schedules; }
