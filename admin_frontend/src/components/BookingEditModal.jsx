...
const BookingEditModal = ({ booking, isOpen, onClose, onBookingUpdated }) => {
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <span className="ml-2 font-medium">{booking.experience?.title}</span>
                </div>
                <div>
                  <span className="text-gray-500">Email:</span>
                  <span className="ml-2 font-medium">{booking.traveler?.email}</span>
                </div>
              </div>
            </div>
